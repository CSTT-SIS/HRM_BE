...
export class TimeKeepingService {
    ...
    create(createTimeKeepingDto: CreateTimeKeepingDto, files: Array<Express.Multer.File>) {
    ...
    update(id: number, updateTimeKeepingDto: UpdateTimeKeepingDto, files: Array<Express.Multer.File>) {
